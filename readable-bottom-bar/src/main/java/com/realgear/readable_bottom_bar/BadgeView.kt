...
class BadgeView @JvmOverloads constructor(
    ...
    private val animator =
        ...
        addUpdateListener {
            if (!scaleLayout) {
                when (animationType) {
                    ReadableBottomBar.BadgeAnimation.NONE -> {
                    }
                    ReadableBottomBar.BadgeAnimation.SCALE -> {
                        val scale = it.animatedValue as Float
                        scaleX = scale
                        scaleY = scale
                    }
                    ReadableBottomBar.BadgeAnimation.FADE -> {
    ...
    var animationType: ReadableBottomBar.BadgeAnimation = ReadableBottomBar.BadgeAnimation.SCALE
    ...
    override fun onMeasure(widthMeasureSpec: Int, heightMeasureSpec: Int) {
        ...
        if (animationType == ReadableBottomBar.BadgeAnimation.SCALE) {
            super.onMeasure(
    ...
    override fun setEnabled(enabled: Boolean) {
        ...
        if (animationType == ReadableBottomBar.BadgeAnimation.NONE) {
